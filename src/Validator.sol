    ...
    Operator
{
    ...
    function name() external pure override returns (string memory serviceName) {
        return SERVICE_NAME;
    }

    /// @inheritdoc IFilecoinServiceMetadata
    function description() external pure override returns (string memory serviceDescription) {
        return SERVICE_DESCRIPTION;
    }

    /// @inheritdoc IFilecoinServiceMetadata
    function homepage() external pure override returns (string memory serviceHomepage) {
