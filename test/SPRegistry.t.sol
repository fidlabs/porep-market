...
contract SPRegistryTest is Test {
    ...
    function testAutoMatchSkipsOrganizationAlreadyAssignedToManifest() public {
        ...
        assertTrue(spRegistry.isManifestAssignedToOrganization(client1, manifestHash, owner1));
        ...
        assertTrue(spRegistry.isManifestAssignedToOrganization(client1, manifestHash, owner2));
    }
    ...
    function testManifestAssignmentIsScopedPerClientNotGlobal() public {
        ...
        assertTrue(spRegistry.isManifestAssignedToOrganization(client2, manifestHash, owner1));
        assertFalse(spRegistry.isManifestAssignedToOrganization(client1, manifestHash, owner1));
