...
contract FailingMockInvalidSecondElementInnerLength {
    ...
    fallback(bytes calldata data) external payable returns (bytes memory) {
        ...
        revert MethodNotFound( "FailingMockInvalidSecondElementInnerLength", methodNum, target);
    }
    ...
    function _handleDatacapTransfer() internal pure returns (bytes memory) {
        return abi.encode(EXIT_CODE_SUCCESS, 0x51, hex"83410041004B8382018082008200008101");
    }
}
