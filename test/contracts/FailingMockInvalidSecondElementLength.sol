...
contract FailingMockInvalidSecondElementLength {
    ...
    fallback(bytes calldata data) external payable returns (bytes memory) {
        ...
        revert MethodNotFound("FailingMockInvalidSecondElementLength", methodNum, target);
    }
    ...
    function _handleDatacapTransfer() internal pure returns (bytes memory) {
        return abi.encode(EXIT_CODE_SUCCESS, 0x51, hex"83410041004A83820180830080808101");
    }
}
